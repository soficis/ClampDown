...
static async Task RunServerAsync(string pipeName, string expectedAuthToken, int allowedClientPid)
{
    while (true)
    {
...
static string? ValidateAuthorization(
...
static bool TokensMatch(string providedToken, string expectedToken)
{
